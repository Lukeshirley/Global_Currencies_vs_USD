...
def visualize_performance(df):
    ...
    sns.heatmap(df_filtered_values.fillna(0), annot=df_filtered, cmap=cmap, fmt="", linewidths=.5, cbar=True, annot_kws={"size": 12}, center=0, vmin=-15, vmax=50)
    ...
    sns.heatmap(df_cryptos_values.fillna(0), annot=df_cryptos, cmap=cmap, fmt="", linewidths=.5, cbar=True, annot_kws={"size": 12}, center=0, vmin=-50, vmax=200)
