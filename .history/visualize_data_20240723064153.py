...
def visualize_performance():
    ...
    # Replace with the actual available major currencies from the check_currencies.py output
    available_currencies = df.columns.tolist()  # Get all available currencies from the DataFrame
    major_currencies = ['USD', 'EUR', 'JPY', 'GBP', 'AUD', 'CAD', 'CHF', 'CNY', 'HKD', 'NZD']  # Example list
